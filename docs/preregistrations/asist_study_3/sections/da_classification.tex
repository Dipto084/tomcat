...
data is 40.77. However, when we evalute the trained model on ASIST study 3 data, 
...
generated by the ASR. In order to solve this issue we have to manually correctthe
